...
using ValidationException = MediCore.Application.UseCase.Commons.Exceptions.ValidationException;

namespace MediCore.Application.UseCase.Commons.Behaviours
{
